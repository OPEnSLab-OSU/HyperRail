...
const uint16_t LORA_HUB_ADDRESS = 00; // this is the hub
...
RHReliableDatagram manager(rf95, LORA_NODE_ADDRESS); //make sure the address is the hub address. If it is not, this won't work.
