...
\begin{center}
	\begin{ganttchart}{1}{6}
		...
		\ganttbar{Design and Test Web Interface}{1}{6} \ganttnewline
		\ganttbar{Design and Test Server}{1}{6} \ganttnewline
		\ganttbar{Link Server with Hardware}{4}{6} \ganttnewline
		\ganttbar{Optimize Code}{5}{6} \ganttnewline
		\ganttbar{Work on Stretch Goals}{6}{6} \ganttnewline
